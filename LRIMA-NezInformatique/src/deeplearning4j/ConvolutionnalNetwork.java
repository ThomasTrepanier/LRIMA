...
//		trainingSetIterator.setPreProcessor(scaler);
		...
		try {
			ModelUtils.saveModelResults(model, eval, trainTime, batchSize, nbLabels, nbOfChannels, epochs, false);
...
//        System.out.println(Arrays.toString(predictedClasses));
	...
	private static MultiLayerNetwork initializeConvModel(int seed, int nbOfChannels, int[] nHidden, int nOut,
